...
export const Sizes: Story = {
  ...
  play: async ({ canvas }) => {
    const smallAvatar = canvas.getByText('S');
    const mediumAvatar = canvas.getByText('M');
    const largeAvatar = canvas.getByText('L');

    await expect(smallAvatar).toBeInTheDocument();
    await expect(mediumAvatar).toBeInTheDocument();
